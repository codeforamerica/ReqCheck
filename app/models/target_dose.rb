class TargetDose
  ...
  def create_conditional_skip_set_condition_attributes(
    ...
    time_atrributes = ['begin_age', 'end_age']
    condition_attrs = create_calculated_dates(time_attributes, condition,
                                              dob, condition_attrs)
    
    interval_date = create_patient_age_date(condition.interval,
                                            previous_dose_date)
    
    condition_attrs[:interval_date] = interval_date
    ...
    condition_attrs[:vaccine_types]    = condition.vaccine_types.split(";") 
    condition_attrs
  end
